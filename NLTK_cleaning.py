...
#I deleted the index column that was treated as an actual column from excel, giving us 2 index columns
degrees = pandas.read_csv(r"C:\Users\youse\Desktop\ADM Hw3\Databases\Parsed_database.csv")
